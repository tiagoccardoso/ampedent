...
VALUES
  ('home', 'Reconecte-se com o seu sorriso', 'DentalSys - Uma nova abordagem para o conforto odontológico', 'Torne seu sorriso perfeito ainda melhor', '{}'::jsonb),
  ('about', 'Conheça a DentalSys: onde os sorrisos brilham mais', 'Nossa missão', 'Na DentalSys, nossa missão é oferecer cuidado odontológico excepcional em um ambiente confortável e acolhedor.', '{}'::jsonb),
