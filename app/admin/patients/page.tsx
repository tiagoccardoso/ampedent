  ...
  try {
    if (!fullName || !phone) {
      ...
      await sql`
        ...
        values (${fullName}, ${phone}, ${optional(formData.get('cpf'))}, ${optional(formData.get('birth_date'))}, ${optional(formData.get('email'))}, ${optional(formData.get('address'))}, ${optional(formData.get('guardian_name'))}, ${optional(formData.get('notes'))}, ${String(formData.get('status') || 'active')}::patient_status)
      `
