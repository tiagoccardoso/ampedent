...
const ICONS = {
  ...
  plans: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
...
export default function NavLinks() {
  ...
  return (
    <>
      ...
      <Link href='/admin/treatment-plans' className={cls(pathname.startsWith('/admin/treatment-plans'))}>
        <NavIcon d={ICONS.plans} />
        <span className='hidden md:inline'>Planos</span>
        <span className='md:hidden text-[10px]'>Planos</span>
      </Link>
      ...
      {(role === 'superadmin' || role === 'admin') && (
        <>
          ...
          <Link href='/admin/reports' className={cls(pathname.startsWith('/admin/reports'))}>
            <NavIcon d={ICONS.reports} />
